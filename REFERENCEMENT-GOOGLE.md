...
![Choix du type de propriété dans Google Search Console](img/referencement/01-type-propriete.png)
...
![Méthode de validation par fichier HTML](img/referencement/02-validation-fichier-html.png)
...
![Écran de validation (variante)](img/referencement/03-validation-fichier-html-2.png)

![Écran de validation (variante)](img/referencement/04-validation-fichier-html-3.png)
...
![Contenu du fichier de vérification Google](img/referencement/05-contenu-fichier-verification.png)
...
![La propriété a été validée](img/referencement/06-propriete-validee.png)
...
![Inspection de l'URL et demande d'indexation](img/referencement/07-inspection-url.png)
...
![Ajouter un sitemap](img/referencement/08-ajouter-sitemap.png)
*On saisit simplement `sitemap.xml` dans le champ, puis « Envoyer ».*

![Sitemap envoyé](img/referencement/09-sitemap-envoye.png)
...
![État : Impossible de récupérer le sitemap](img/referencement/10-sitemap-erreur-recuperer.png)
*Dans la liste des sitemaps : état « Impossible de récupérer le sitemap ».*

![Détail : Impossible de lire le sitemap](img/referencement/11-sitemap-erreur-lire.png)
